    ...
    <div className="prose-measure flex flex-col gap-9">
      ...
      <section>
        ...
        <ul className="mt-2 flex flex-col gap-2 text-[14px] leading-relaxed text-ink-2">
          ...
          <li>Claims are extracted by deterministic rules from headlines and short excerpts. The engine still misses a share of genuine same-fact pairs (a structured <a href="https://github.com/Rishidar-lab/info-for-all/blob/main/docs/EVENT-IDENTITY.md" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">event-identity engine</a> recovers most; some Tamil inflections and state-level aggregates remain), and it never merges a pair it is unsure about — precision on the labelled corpus is 100%. The linked source is authoritative.</li>
