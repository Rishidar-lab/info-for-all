...
export const FEED_SOURCES: FeedSource[] = [
  ...
  // ── v0.10 Phase 8 — media-landscape source expansion (validated 2026-09-03) ──
  {
    ...
    role: "independent",
    enabled: true,
    ownershipGroup: "Indian Express Group",
    sourceType: "newspaper",
    categorySupport: ["crisis", "politics", "finance", "sports", "other-relevant"],
    region: "india",
    note: "Major national English daily. HTTP 200, 200 items with pubDate. Validated 2026-09-03.",
  },
  {
    id: "frontline-thehindu",
    ...
    ownershipGroup: "Kasturi & Sons",
    sourceType: "newspaper",
    categorySupport: ["politics", "other-relevant"],
    region: "india",
    note: "Fortnightly current-affairs magazine, The Hindu Group. HTTP 200, 60 items. Same family as The Hindu.",
  },
  {
    id: "business-standard-top",
    ...
    categorySupport: ["finance", "politics", "other-relevant"],
    region: "india",
    note: "Financial daily. v0.10 re-check: HTTP 200, 7 items, no Akamai block on this endpoint (the economy-policy feed was 403). Validated 2026-09-03.",
  },
  {
    ...
    enabled: true,
    trustFeedScope: false,
    ownershipGroup: "Network18 / Reliance",
    sourceType: "digital_native",
    categorySupport: ["finance"],
    region: "india",
    note: "Markets / finance. v0.10 re-check: HTTP 200, 15 items with real titles + pubDate, no Akamai 'Access Denied' body (earlier block cleared). Validated 2026-09-03. Network18 family.",
  },
  {
    id: "altnews-factcheck",
    name: "Alt News — fact checks",
    publisher: "Alt News",
    homepage: "https://www.altnews.in/",
    url: "https://www.altnews.in/feed/",
    kind: "rss",
    defaultEvidenceRole: "fact-check",
    official: false,
    language: "en",
    focus: "india",
    role: "specialist",
    enabled: true,
    sourceType: "digital_native",
    categorySupport: ["politics", "crisis", "other-relevant"],
    region: "india",
    note: "IFCN-signatory fact-checker (Pravda Media Foundation, non-profit). HTTP 200, 10 items with pubDate. Validated 2026-09-03. Fact-check verdicts, not primary reporting.",
  },
  {
    id: "factly-factcheck",
    name: "Factly — fact checks",
    publisher: "Factly",
    homepage: "https://factly.in/",
    ...
    enabled: true,
    sourceType: "digital_native",
    categorySupport: ["politics", "finance", "other-relevant"],
    region: "india",
    note: "IFCN-signatory fact-checker + government-data explainers (Factly Media & Research). HTTP 200, 10 items. Validated 2026-09-03. English + Telugu items.",
  },

  // ── v0.11 Phase A/B — Tamil-native + regional source expansion (validated 2026-09-03) ──
  {
    id: "hindu-tamil",
    name: "இந்து தமிழ் திசை (The Hindu Tamil)",
    publisher: "The Hindu Tamil",
    ...
    categorySupport: ["crisis", "politics", "finance", "sports", "other-relevant"],
    region: "tamil-nadu",
    note: "Major Tamil daily (The Hindu Group). The WordPress /feed path returns HTTP 200 / 37 items with pubDate and direct publisher URLs — NOT Akamai-blocked (the /rss/*.xml paths are). Validated 2026-09-03. Kasturi & Sons family.",
  },
  {
    id: "abp-tamil",
    name: "ABP நாடு (ABP Tamil)",
    publisher: "ABP Tamil",
    homepage: "https://tamil.abplive.com/",
    url: "https://tamil.abplive.com/home/feed",
    kind: "rss",
    defaultEvidenceRole: "independent-report",
    official: false,
    language: "ta",
    ...
    role: "independent",
    enabled: true,
    ownershipGroup: "ABP Group",
    sourceType: "digital_native",
    categorySupport: ["politics", "crisis", "other-relevant"],
    region: "tamil-nadu",
    note: "Tamil digital news (ABP Network). HTTP 200, 21 items with pubDate, direct URLs. Validated 2026-09-03.",
  },
  {
    id: "nakkheeran-tamil",
    name: "நக்கீரன் (Nakkheeran)",
    publisher: "Nakkheeran",
    homepage: "https://www.nakkheeran.in/",
    url: "https://www.nakkheeran.in/rss",
    kind: "rss",
    defaultEvidenceRole: "independent-report",
    official: false,
    language: "ta",
    ...
    categorySupport: ["politics", "other-relevant"],
    region: "tamil-nadu",
    note: "Tamil political / investigative news (WordPress feed). HTTP 200, 50 items with pubDate. Validated 2026-09-03.",
  },
  {
    ...
    categorySupport: ["crisis", "politics", "finance", "sports", "other-relevant"],
    region: "india",
    note: "National English daily (Mumbai). HTTP 200, 65 items with pubDate. Validated 2026-09-03.",
  },
  {
    id: "thehindu-puducherry",
    name: "The Hindu — Puducherry",
    publisher: "The Hindu",
    homepage: "https://www.thehindu.com/news/cities/puducherry/",
    url: "https://www.thehindu.com/news/cities/puducherry/feeder/default.rss",
    kind: "rss",
    defaultEvidenceRole: "independent-report",
    official: false,
    language: "en",
    ...
    ownershipGroup: "Kasturi & Sons",
    sourceType: "newspaper",
    categorySupport: ["crisis", "politics", "other-relevant"],
    region: "tamil-nadu",
    note: "Puducherry / Karaikal regional coverage. HTTP 200, 60 items. Validated 2026-09-03.",
  },
];
...
export const CANDIDATE_FEEDS: {
  ...
  { id: "moneycontrol-latest", publisher: "Moneycontrol", category: "finance", url: "https://www.moneycontrol.com/rss/latestnews.xml", status: "enabled", note: "v0.10 Phase 8: HTTP 200, 15 items with real titles + pubDate, the Akamai 'Access Denied' body is gone. Enabled 2026-09-03. Network18 family." },
  { id: "business-standard-top", publisher: "Business Standard", category: "finance", url: "https://www.business-standard.com/rss/home_page_top_stories.rss", status: "enabled", note: "v0.10 Phase 8: the home_page_top_stories endpoint returns HTTP 200 / 7 items (the economy-policy feed was 403). Enabled 2026-09-03." },
  { id: "indian-express-india", publisher: "The Indian Express", category: "politics", url: "https://indianexpress.com/section/india/feed/", status: "enabled", note: "v0.10 Phase 8: HTTP 200, 200 items with pubDate. Enabled 2026-09-03." },
  { id: "frontline-thehindu", publisher: "Frontline", category: "politics", url: "https://frontline.thehindu.com/feeder/default.rss", status: "enabled", note: "v0.10 Phase 8: HTTP 200, 60 items. The Hindu Group / Kasturi & Sons family. Enabled 2026-09-03." },
  { id: "altnews-factcheck", publisher: "Alt News", category: "other-relevant", url: "https://www.altnews.in/feed/", status: "enabled", note: "v0.10 Phase 8: IFCN fact-checker. HTTP 200, 10 items. Enabled 2026-09-03 with evidenceRole=fact-check." },
  { id: "factly-factcheck", publisher: "Factly", category: "other-relevant", url: "https://factly.in/feed/", status: "enabled", note: "v0.10 Phase 8: IFCN fact-checker + govt-data explainers. HTTP 200, 10 items. Enabled 2026-09-03 with evidenceRole=fact-check." },
