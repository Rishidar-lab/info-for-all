...
const TAMIL_SUFFIXES: string[] = [
  ...
  // postposition "in connection with / following" (X-ஐ ஒட்டி / X-ஐயொட்டி)
  "ையொட்டி", "ஐயொட்டி", "யொட்டி",
  // dative "to/for"
...
const TAMIL_CONCEPTS: Record<string, string> = {
  ...
  "பெருமழை": "heavy-rain",
  "வெள்ள": "flood",
  "வெள்ளப்பெருக்கு": "flood",
  "நீர் வரத்து அதிகரி": "flood",
  "எச்சரிக்கை": "warning",
  "அலர்ட்": "alert",
  "சிவப்பு": "red",
  "ஆரஞ்சு": "orange",
  ...
  "கடலோர": "coast",
  "கொந்தளி": "rough-sea",
  "கடல் சீற்ற": "rough-sea",
  "கடல் அலை": "rough-sea",
  "அலைகள் அதிகரி": "rough-sea",
  "படகு": "boat",
  "கரையை கட": "landfall",
  "கரை கட": "landfall",
  "கரையைக் கட": "landfall",
  ...
  "சேதம்": "damage",
  "சேதமடைந்த": "damage",
  "போக்குவரத்து மாற்ற": "diversion",
  "வழி மாற்ற": "diversion",
  "பாதை மாற்ற": "diversion",
  "திசை மாற்ற": "diversion",
  "வழித்தட": "diversion",
  "மாற்று வழி": "diversion",
  "காவல்துறை": "police",
  "அமைச்சர்": "minister",
