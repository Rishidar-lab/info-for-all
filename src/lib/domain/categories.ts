...
const CRISIS: CategoryMatcher[] = [
  ...
  { category: "crisis", subCategory: "power_outage", any: ["power outage", "grid failure", "blackout", "major power cut", "power shutdown"] },
...
const POLITICS: CategoryMatcher[] = [
  ...
  { category: "politics", subCategory: "assembly", any: ["assembly session", "state assembly", "legislative assembly", "assembly passes", "walkout", "adjournment motion"] },
  { category: "politics", subCategory: "parliament", any: ["parliament", "lok sabha", "rajya sabha", "monsoon session", "winter session", "bill passed"] },
...
const FINANCE: CategoryMatcher[] = [
  ...
  { category: "finance", subCategory: "fuel_price", any: ["petrol price", "diesel price", "lpg price", "fuel price hike", "cng price"] },
