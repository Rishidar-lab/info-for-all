...
const POLITICS: CategoryMatcher[] = [
  ...
  { category: "politics", subCategory: "campaign", any: ["campaign", "roadshow", "public meeting", "election rally", "poll rally", "campaign rally", "public rally", "padayatra", "election tour", "poll strategist", "as pm", "for pm", "pm pitch", "prime minister in 2029"] },
